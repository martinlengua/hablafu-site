    ...
    <section className="features">
      ...
      <div className="features-grid">
        <div className="feature-item">
          <img src={foto1} alt="Calidad Profesional" className="feature-image" />
        ...
        <div className="feature-item">
          <img src={foto2} alt="Asistencia Técnica" className="feature-image" />
          <div className="feature-overlay">
        ...
        <div className="feature-item">
          <img src={foto3} alt="Espacio Ideal" className="feature-image" />
          <div className="feature-overlay">
            <h3>Espacio Ideal</h3>
